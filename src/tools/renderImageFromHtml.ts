...
export const renderImageFromHtmlSchema = z.object({
  ...
  "Renders an existing HTML file into an image (PNG or JPEG). Use this tool after you have successfully saved an HTML file with 'saveHtml'."
);
...
export async function renderImageFromHtml(args: RenderImageFromHtmlArgs, workspacePath: string) {
  ...
  try {
    ...
    await page.screenshot({
      path: validatedImagePath as `${string}.png` | `${string}.jpeg`,
      type: imageType,
